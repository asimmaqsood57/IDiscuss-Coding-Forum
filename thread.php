...
if ($method == 'POST') {
  ...
  $sql = "INSERT INTO `comments` ( `coment_content`, `thread_id`, `comment_by`, `comment_time`) VALUES ( '$content', '$id', '$userid', current_timestamp());";
...
<p><b>Posted By: </b> <?php  echo $postedby ?></p>
...
<h5 class="m-1" ><b>'.$row2['user_email'].'</b></h5> at '.$time.'
